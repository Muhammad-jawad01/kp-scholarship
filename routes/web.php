...
|
*/
// Redirector Basic on User Type




Route::get('Home', function () {
    if (\Auth::User()->type == 'youth') {
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::group(['prefix' => 'dashboard'], function () {
        ...
        Route::get('ecommerce', [DashboardController::class, 'dashboardEcommerce'])->name('dashboard-ecommerce-internal');
    });
    /* Route Dashboards */
