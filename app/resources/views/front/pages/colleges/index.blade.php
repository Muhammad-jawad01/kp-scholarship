                    ...
                    <thead class="thead-light">
                        ...
                        <tbody>
                            @foreach ($colleges as $college)
                                <tr>
                                    <td>{{$college->dist_name}}</td>
                                    <td>{{$college->name}}</td>
                                    <td>{{$college->organized_by}}</td>
                                    <td>{{$college->address}}</td>
                                    <td>{{$college->phone}}</td>
                                    <td><a href="{{$college->getFirstMediaUrl('prospectus')}}">Download</a></td>
                                    <td><a href="{{route('pages.college-details', $college->id)}}" class="btn btn-danger">Details</a></td>
                                </tr>
                            @endforeach
                        </tbody>
                </table>
