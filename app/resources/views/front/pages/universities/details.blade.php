                ...
                <nav aria-label="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{url('/')}}" class="text-decoration-none">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">{{$pageData->title}}
                            <li class="breadcrumb-item active" aria-current="page"><a href="{{route('pages.universities')}}">Universities</a></li>
                            <li class="breadcrumb-item active" aria-current="page">University Details</li>
                        </li>
                    </ol>
                </nav>
            </div>
