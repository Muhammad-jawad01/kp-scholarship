...
@section('title', 'Facilities/Youth Affairs')
@section('content')
                ...
                <nav aria-label="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{url('/')}}" class="text-decoration-none">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">{{$pageData->title}}
                            <li class="breadcrumb-item active" aria-current="page">Youth Affairs</li>
                        </li>
                    </ol>
                </nav>
            </div>
                   ...
                   <tbody>
                        @foreach ($facilities as $facility)
                            <tr>
                                ...
                                <td colspan="2"><b>lat:</b>{{$facility->latitude}}, <b>long:</b>{{$facility->longitude}}</td>
