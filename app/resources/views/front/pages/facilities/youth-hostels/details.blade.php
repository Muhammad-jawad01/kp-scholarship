...
@section('title', 'Facilities-Youth Hostels Details')
@section('content')
<style>
        .list-inline-item {
                                        ...
                                        @if (count($mediaItems) > 0)
                                            @foreach ($mediaItems as $key => $media)
                                                <div class="col-lg-3 mb-2 pr-lg-1"><img
                                                        ...
                                                        class="img-fluid rounded shadow-sm img-thumbnail details-image"></div>
                                                {{-- <div class="col-md-3">
                                                    <img src="{{ $mediaItems[$key]->getFullUrl() }}" alt="">
                                                </div> --}}
                                            @endforeach
