...
@section('title', 'Downloads/KP Youth Affairs')
@section('content')
            ...
            <div class="breadcrumbs-con">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">KP Youth Policies</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <table class="table datatable">
                   ...
                   <tbody>
                        @foreach ($policies as $policy)
                            ...
                            <td><a href="{{$policy->getFirstMediaUrl('download')}}">Download</a></td>
                        @endforeach
                   </tbody>
                </table>
