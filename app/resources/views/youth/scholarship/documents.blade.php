                                ...
                                <tbody id="tablebody">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{ BsForm::image('applicant_nic')->collection('applicant_nic')->files($model ? $model->getMediaResource('applicant_nic') : []) }}
                                            {{-- {{ BsForm::image('p_nic')->collection('p_nic')->files() }} --}}
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ BsForm::image('p_nic')->collection('p_nic')->files($model ? $model->getMediaResource('p_nic') : []) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>3</th>
                                        <td>Salary Slip/Income Certificate (Father/Guardian, Mother)</td>
                                        <td>{{ BsForm::image('income_slip')->collection('income_slip')->files($model ? $model->getMediaResource('income_slip') : []) }}
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Copies of last six-month utility bills (Electricity Gas, Telephone, water)
                                            (if applicable) </td>
                                        <td>{{ BsForm::image('bills')->collection('bills')->files($model ? $model->getMediaResource('bills') : []) }}
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ BsForm::image('agreement_rent')->collection('agreement_rent')->files($model ? $model->getMediaResource('agreement_rent') : []) }}
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>Copies of Last Fee Receipts of Applicant and Siblings
                                            (if applicable )</td>
                                        <td>{{ BsForm::image('last_fee')->collection('last_fee')->files($model ? $model->getMediaResource('last_fee') : []) }}
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>Copies of Medical Bills/expenditure related documents
                                            (if applicable )</td>
                                        <td>{{ BsForm::image('medical_bills')->collection('medical_bills')->files($model ? $model->getMediaResource('medical_bills') : []) }}
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ BsForm::image('applicant_img')->collection('applicant_img')->files($model ? $model->getMediaResource('applicant_img') : []) }}
                                        </td>
                                    </tr>
