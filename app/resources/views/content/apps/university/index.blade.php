            ...
            <td>
               <div class="dropdown">
                ...
                <div class="dropdown-menu">
                  ...
                  @can('download-edit')
                  <a href="{{ route('universities.edit', $university->id) }}" class="dropdown-item"><i data-feather="edit-2" class="mr-50"></i><span>Edit</span></a>
                  @endcan

                  @can('download-delete')
                  {!! Form::open(['method' => 'DELETE','route' => ['universities.destroy', $university->id],'style'=>'display:inline']) !!}
