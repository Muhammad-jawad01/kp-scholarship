...
<section class="app-user-list">
  ...
  <div class="card">
    <div class="col-lg-12 text-right">
      @can('district-create')
      <a class="btn btn-primary m-2" href="{{route('districts.create')}}">New District</a>
      @endcan
    </div>
            ...
            <td>
               <div class="dropdown">
                ...
                <div class="dropdown-menu">
                  ...
                  @can('district-edit')
                  <a href="{{ route('districts.edit', $district->id) }}" class="dropdown-item"><i data-feather="edit-2" class="mr-50"></i><span>Edit</span></a>
                  @endcan
