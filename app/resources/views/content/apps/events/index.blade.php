          ...
          <div class="col-md-4">
            <div class="card border">
              ...
              <div class="card-body event_card_body">
                <div style="height: 200px;width:100%; background-image: url({{$event->getFirstMediaUrl('event')}}); background-size: cover;">
                </div> 
              </div>
              <div class="card-footer">
                <table>
                  <tr>
                    <td>
                      <a title="Show Details" href="{{ route('event-details', $event->id) }}" class="btn btn-primary"><i data-feather="eye" class="mr-50"></i></a>
                    </td>
                    <td> 
                      @can('event-edit')
                      <a title="Edit" href="{{ route('events.edit', $event->id) }}" class="btn btn-primary"><i data-feather="edit-2" class="mr-50"></i></a>
                      @endcan
                    </td>
                    <td>
                      @can('event-delete')
