...
<section class="app-user-list">
  ...
  <div class="card">
    <div class="col-lg-12 text-right">
      @can('download-create')
      <a class="btn btn-primary m-2" href="{{route('books.create')}}">New Book</a>
      @endcan
    </div>
            ...
            <td>
               <div class="dropdown">
                ...
                <div class="dropdown-menu">
                  ...
                  @can('download-edit')
                  <a href="{{ route('books.edit', $book->id) }}" class="dropdown-item"><i data-feather="edit-2" class="mr-50"></i><span>Edit</span></a>
                  @endcan
