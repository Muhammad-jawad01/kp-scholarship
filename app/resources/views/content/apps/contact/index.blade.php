...
<section class="app-user-list">
  ...
  <div class="card">
    <div class="col-lg-12 text-right">
      @can('contact-create')
      <a class="btn btn-primary m-2" href="{{ route('contacts.create') }}"> New Contact</a>
      @endcan
    </div>
            ...
            <td>
              <div class="dropdown">
                ...
                <div class="dropdown-menu">
                  ...
                  @can('contact-edit')
                  <a href="{{ route('contacts.edit', $contact->id) }}" class="dropdown-item"><i data-feather="edit-2" class="mr-50"></i><span>Edit</span></a>
                  @endcan
