                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a href="{{ route('scholarship.edit', $data->id) }}" class="dropdown-item"><i
                                            ...
                                            <button type="submit" class="dropdown-item "><i data-feather="trash"
                                                    class="mr-50"></i> <span>Delete</span></button>

                                            {!! Form::close() !!}
                                            {{-- @endcan --}}

                                            <a href="{{ route('scholarship.show', $data->id) }}" class="dropdown-item"><i
                                                    data-feather="eye" class="font-medium-3">show</i></a>
                                        </div>
                                    </div>
