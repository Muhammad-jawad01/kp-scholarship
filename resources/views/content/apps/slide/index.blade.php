                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($slide->getFirstMediaUrl('slide') != '')
                                        <img class="img-fluid rounded mb-75" src="{{ $slide->getFirstMediaUrl('slide') }}"
                                ...
                                <td>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            @can('slide-edit')
                                                <a href="{{ route('slides.edit', $slide->id) }}" class="dropdown-item">
                                                    {{-- <i
                                                        data-feather="edit-2" class="mr-50"></i> --}}
                                                    <i class="fa fa-edit " aria-hidden="true"></i>

                                                    <span>
                                                        {{ __('locale.Edit') }}</span></a>
                                            @endcan
                                            ...
                                            @can('slide-delete')
                                                ...
                                                <button type="submit" class="dropdown-item ">
                                                    ...
                                                    <span> {{ __('locale.Delete') }}</span></button>
