            ...
            <div class="card-body">
                ...
                <form action="{{ route('projects.update', $project->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="approved_pc1_cost" placeholder="approved_pc1_cost"
                            value="{{ $project->approved_pc1_cost }}">
                    </div>
                    ...
                    <div class="form-group" id="app">
                        ...
                        {{ BsForm::media('work-project')->collection('work-project')->files($project->getMediaResource('work-project')) }}
