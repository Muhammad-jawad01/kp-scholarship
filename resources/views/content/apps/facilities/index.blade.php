...
@section('content')
    ...
    @endcan
        ...
        {!! Form::open([
            'method' => 'DELETE',
            'route' => ['facilities.destroy', $facility->id],
                ...
                @foreach ($facilities as $facility)
                    <div class="col-md-4">
                        <div class="card border">
                            ...
                            <div class="card-body"
                                style="height: 200px; width: 315px; background-image: url({{ $facility->getFirstMediaUrl('facility') }}); background-size: cover;">
                            </div>
                            <div class="card-footer">
                                <table>
                                    <tr>
                                        <td>
                                            <a title="Show Details" href="{{ route('facility-details', $facility->id) }}"
                                        ...
                                        <td>
                                            @can('facility-edit')
                                                <a title="Edit" href="{{ route('facilities.edit', $facility->id) }}"
                                                    class="btn btn-primary">
