        ...
        <div class="card-body">
            ...
            <form action="{{route('store.comment')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="subject" id="" value="{{$feedback->subject}}" disabled />
                </div>
                <div class="form-group">
                    <label for="feedback">Feedback</label><br>
                    <textarea name="feedback" disabled id="" cols="90" rows="3">{{$feedback->message}}</textarea>
                </div>
                <div class="form-group">
                    <label for="comment">Comment</label><br>
                    <textarea name="comment" id="" cols="90" rows="3"></textarea>
                </div>
