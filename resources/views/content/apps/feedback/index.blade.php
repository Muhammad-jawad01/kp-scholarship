                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="{{ route('add.comment', $message->id) }}" class="dropdown-item">
                                                {{-- <i data-feather="edit-2" class="mr-50"></i> --}}
                                                <i class="fa fa-edit " aria-hidden="true"></i>

                                                <span>Post Comment</span></a>
                                            <a href="{{ route('comments', $message->id) }}" class="dropdown-item">
                                                {{-- <i data-feather="message-square" class="mr-50"></i> --}}
                                                <i class="fa fa-message-square " aria-hidden="true"></i>
