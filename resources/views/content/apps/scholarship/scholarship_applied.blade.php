    ...
    <section class="app-user-list">
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="card mb-2 ">
                        <div class="card-header flex-column align-items-start pb-0">
                            ...
                            <h2 class="fw-bolder mt-1">{{ $approved_uni ?? '' }}</h2>
        ...
        <div class="card">
            ...
            <div class="table table-responsive p-2">
                ...
                <table class="table " id="data_table_list">
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a href="{{ route('reports.show', encrypt($data->id)) }}"
                                                class="dropdown-item">
                                                @if (isset($feather))
                        ...
                        <form id="change_status_form">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-select form-control" id="selectval" name="status"
...
@section('page-script')
    ...
    <script>
        $(document).ready(function() {
            // Debugging log to make sure the script is loaded properly
            console.log("Script loaded successfully.");

            $('.getDataId').on('click', function() {
                var editId = $(this).attr('data-id');

                // Check if the editId is being correctly fetched
            ...
            $('#change_status_form').on('submit', function(event) {
                event.preventDefault(); // Prevent the default form submission
                console.log("Form submission intercepted."); // Debug log to ensure this is triggered
                // alert('test')
                // Fetch form data
                var EditId = $('#sch_id').val();
                var status = $('#selectval').val();
                var comment = $('#Textarea').val();
                var url =
                    '{{ route('scholarship_applied.update', ['scholarship_applied' => 'SCHOLARSHIP_ID_PLACEHOLDER']) }}';
                url = url.replace('SCHOLARSHIP_ID_PLACEHOLDER', EditId);
                var data = {
                    status: status,
                    comment: comment,
                    id: EditId,
                ...
                // Log data to verify values are correct
                console.log(data);
    ...
    <script>
        $(document).ready(function() {
            $('#data_table_list').DataTable({
                ...
                buttons: ['copy', 'excel', 'pdf'], // Optional: Add export buttons
            });
        });
    </script>
