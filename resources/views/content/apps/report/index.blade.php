    ...
    <section class="app-user-list">
        ...
        <div class="card">
            ...
            <div class="col-lg-12 ">
                ...
                <form action="{{ route('reports.index2') }}" method="get">
                    <div class="row my-3">
                        <div class="col-md-10 my-2">
                            <input type="text" name="user_cnic" class="form-control" id="user_cnic"
                    ...
                    <div class="row my-3">
                        ...
                        <div class="col-sm-2">
                            <select name="status" id="status" class="form-control">
                                ...
                                <option value="1">New Apply</option>
                            ...
                            @foreach ($report as $data)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('reports.show', $data->id) }}" class="dropdown-item">
                                            @if (isset($feather))
