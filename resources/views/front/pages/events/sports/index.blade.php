...
@section('content')
    ...
    <section class="news-page-details">
        <div class="custom-container">
            <div class="container">
                <h3 class="val-center val-white p-1 gradient-bg text-center text-white">Sports Events Calendar</h3>
                <div id="calendar"></div>
            </div>
        </div>
        <!-- ====== Modal =========  -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header gradient-bg text-white w-100 p-2 text-center">
                        <h3 class="modal-title">Sports Event Details</h3>
                    ...
                    $('#calendar').fullCalendar({
                        ...
                        eventClick: (events) => {
                            ...
                            $(".modal-body #participants").html(
                                "<p class='p-1'><b>Participants:</b> " + events
                                .participants +
                                "</p>");
