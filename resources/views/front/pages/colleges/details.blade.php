                ...
                <nav aria-label="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{url('/')}}" class="text-decoration-none">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">{{$pageData->title}}
                            <li class="breadcrumb-item active" aria-current="page"><a href="{{route('pages.colleges')}}">Colleges</a></li>
                            <li class="breadcrumb-item active" aria-current="page">College Details</li>
                        </li>
                    </ol>
                </nav>
            </div>
                    ...
                    <thead class="thead-light">
                        ...
                        <tbody>
                            @foreach ($collegeDetails as $detail)
                                <tr>
                                    <td colspan="2">{{$detail->course_offered}}</td>
