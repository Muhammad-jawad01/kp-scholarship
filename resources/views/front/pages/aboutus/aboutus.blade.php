...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="banner-header-text">
                        ...
                        <p class="text-center sectionDes text-dark px-md-5 mb-4">
                        ...
                        <div class="d-inline-block position-relative">
                            <span class="badge rounded-pill px-4 py-2 bg-white text-primary fs-6 shadow-sm">
                        ...
                        <div
                            ...
                            <div class="row g-3">
                                <div class="col-6 border-end text-center">
                                    ...
                                    <p class="small mb-0">Scholarships</p>
                                </div>
                ...
                <div class="col-lg-6 order-1 order-lg-2">
                    <div class="about-content ps-lg-4">
                        <div class="d-flex align-items-center mb-4">
                            <span class="badge rounded-pill px-3 py-2 bg-success bg-opacity-10 text-success me-3">Our
                                Mission</span>
                            <div class="flex-grow-1 border-top border-success opacity-25"></div>
                        </div>
                        <h2 class="sectionHead text-start mb-4">Empowering Through Education</h2>
    ...
    <!-- Initiatives Section -->
    <section class="initiatives-section bg-light section-padding">
        <div class="container">
            <div class="text-center mb-5">
                <span class="badge bg-primary-subtle text-primary px-3 py-2 rounded-pill mb-3">What We Offer</span>
                <h2 class="display-5 fw-bold mb-3">Key Initiatives for Youth Empowerment</h2>
                <p class="text-muted lead">Fostering growth and opportunities for Khyber Pakhtunkhwa's youth through
                    targeted programs.</p>
            </div>
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="card h-100 border-0 shadow rounded-4 initiative-card">
                        <div class="card-body text-center p-4">
                            <div class="icon-wrapper mb-4 mx-auto">
                                <i class="fas fa-graduation-cap fs-1 text-primary"></i>
                            </div>
                            <h5 class="card-title fw-bold mb-3">Educational Excellence</h5>
                            <p class="text-muted mb-4">Comprehensive scholarships for undergraduate and graduate studies to
                                support academic pursuits.</p>
                            <span class="badge bg-success-subtle text-success px-3 py-2 rounded-pill">5,000+ Awarded</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card h-100 border-0 shadow rounded-4 initiative-card">
                        <div class="card-body text-center p-4">
                            ...
                            <h5 class="card-title fw-bold mb-3">Youth Leadership</h5>
                            <p class="text-muted mb-4">Programs building economic, social, and political empowerment for
                                future leaders.</p>
                            <span class="badge bg-primary-subtle text-primary px-3 py-2 rounded-pill">15+ Active
                                Programs</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card h-100 border-0 shadow rounded-4 initiative-card">
                        <div class="card-body text-center p-4">
                            <div class="icon-wrapper mb-4 mx-auto">
                                <i class="fas fa-hands-helping fs-1 text-primary"></i>
                            </div>
                            <h5 class="card-title fw-bold mb-3">Community Impact</h5>
                            <p class="text-muted mb-4">Initiatives promoting volunteerism and civic engagement in local
                                development.</p>
                            <span class="badge bg-warning-subtle text-warning px-3 py-2 rounded-pill">200+ Projects</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="text-center mt-5">
                <a href="{{ route('scholarships.pages') }}" class="btn btn-primary px-5 py-3 rounded-pill shadow">
                    <i class="fas fa-arrow-right me-2"></i> Discover Programs
                </a>
            </div>
        </div>
    </section>
    ...
    <!-- Framework Section -->
    <section class="framework-section section-padding">
        <div class="container">
            <div class="text-center mb-5">
                <span class="badge bg-info-subtle text-info px-3 py-2 rounded-pill mb-3">Our Foundation</span>
                <h2 class="display-5 fw-bold mb-3">Vision & Policy Framework</h2>
                <p class="text-muted lead">Building a comprehensive approach to youth development in Khyber Pakhtunkhwa.
                </p>
            </div>
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="card h-100 border-0 shadow rounded-4 framework-card">
                        <div class="card-body p-4">
                            <div class="mb-4">
                                <div class="icon-bg mb-3">
                                    <i class="fas fa-eye text-primary fs-2"></i>
                                </div>
                                <h4 class="fw-bold gradient-text">Our Vision</h4>
                            </div>
                            <p class="text-muted mb-4">Established in 2017, the Directorate of Youth Affairs provides
                                essential educational support to KP's youth.</p>
                            <div class="values-grid bg-light-subtle p-4 rounded-3">
                                <h6 class="fw-bold mb-3 text-primary"><i class="fas fa-star me-2"></i>Core Values</h6>
                                <div class="row g-3">
                                    <div class="col-6"><i class="fas fa-check text-success me-2"></i>Excellence</div>
                                    <div class="col-6"><i class="fas fa-check text-success me-2"></i>Equality</div>
                                    <div class="col-6"><i class="fas fa-check text-success me-2"></i>Transparency</div>
                                    <div class="col-6"><i class="fas fa-check text-success me-2"></i>Sustainability</div>
                                </div>
                            </div>
                            <a href="#" class="btn btn-outline-primary mt-4 rounded-pill">Learn More</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card h-100 border-0 shadow rounded-4 framework-card">
                        <div class="card-body p-4">
                            <div class="mb-4">
                                <div class="icon-bg mb-3">
                                    <i class="fas fa-file-alt text-info fs-2"></i>
                                </div>
                                <h4 class="fw-bold gradient-text">Youth Policy</h4>
                            </div>
                            <p class="text-muted mb-4">Our policy integrates youth development through three key pillars
                                for systemic impact.</p>
                            <div class="pillar-list">
                                <div class="pillar-item mb-3">
                                    <div class="d-flex align-items-start">
                                        <div class="pillar-icon me-3"><i class="fas fa-chart-line"></i></div>
                                        <div>
                                            <h6 class="fw-bold">Economic Empowerment</h6>
                                            <small class="text-muted">Financial support and entrepreneurship for
                                                sustainable growth.</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="pillar-item mb-3">
                                    <div class="d-flex align-items-start">
                                        <div class="pillar-icon me-3"><i class="fas fa-users"></i></div>
                                        <div>
                                            <h6 class="fw-bold">Social Empowerment</h6>
                                            < almost all of the code remains the same, with minor improvements for clarity
                                                and brevity. Here's the continuation of the code: ```blade <small
                                                class="text-muted">Inclusive networks for holistic personal
                                                development.</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="pillar-item">
                                    <div class="d-flex align-items-start">
                                        <div class="pillar-icon me-3"><i class="fas fa-balance-scale"></i></div>
                                        <div>
                                            <h6 class="fw-bold">Political Empowerment</h6>
                                            <small class="text-muted">Participation in governance and
                            ...
                            <div class="text-center mt-4">
                                <a href="#" class="btn btn-primary rounded-pill px-4"><i
                                        class="fas fa-file-download me-2"></i>Download Policy</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="row g-0">
                                <div class="col-lg-5 position-relative overflow-hidden">
                                    ...
                                    <div class="position-absolute top-0 start-0 w-100 h-100"
                                        style="background: linear-gradient(135deg, rgba(5, 150, 105, 0.92) 0%, rgba(14, 165, 155, 0.92) 100%);">
                                    </div>
