...
@section('content')
    ...
    <section class="vision-policy-section sectionPadding" style="background: linear-gradient(135deg, rgba(167, 243, 208, 0.1), rgba(2, 132, 199, 0.05));">
        <div class="container">
                ...
                <div class="col-lg-8 mx-auto text-center">
                    <div class="mb-3 d-inline-flex align-items-center justify-content-center p-2 rounded-circle" 
                        ...
                        <div class="rounded-circle d-flex align-items-center justify-content-center" 
                            ...
                            <i class="fas fa-compass fa-2x" style="background: var(--grn-grd); -webkit-background-clip: text; background-clip: text; color: transparent;"></i>
                        </div>
                    </div>
                    <span class="badge rounded-pill px-3 py-2 mb-3"
                    ...
                    <p class="sectionDes mx-auto" style="max-width: 700px;">Empowering the youth of Khyber Pakhtunkhwa through educational opportunities and
                        a comprehensive development approach that focuses on sustainable growth and innovation.</p>
                    <div class="title-underline mx-auto mt-4" style="width: 100px; height: 4px; border-radius: 2px; background: var(--grn-grd);"></div>
                </div>
            </div>
            ...
            <div class="row g-4 align-items-stretch">
                ...
                <div class="col-md-6">
                    <div class="card vision-policy-card h-100 border-0 shadow position-relative overflow-hidden" 
                        ...
                        <div class="position-absolute top-0 start-0 w-100" style="height: 6px; background: var(--grn-grd); z-index: 1;"></div>
                        
                        <!-- Curved background shape -->
                        <div class="position-absolute end-0 bottom-0" style="width: 200px; height: 200px; background: var(--grn-grd); opacity: 0.05; border-radius: 100% 0 0 0; transform: translate(30%, 30%);"></div>
                            ...
                            <div class="vision-header mb-4 d-flex flex-column align-items-start">
                                <div class="icon-wrapper p-3 rounded-4 mb-3 position-relative" 
                                    ...
                                    <div class="position-absolute top-50 start-50 translate-middle rounded-circle" 
                                         style="width: 40px; height: 40px; background: var(--grn); opacity: 0.2; animation: pulse-vision 2s infinite;"></div>
                                    <i class="fas fa-eye fs-2" style="color: var(--grn); position: relative; z-index: 2;"></i>
                                </div>
                                <h3 class="card-title fs-2 fw-bold mb-0 gradientHeading2" style="font-size: 2.25rem !important;">Our Vision</h3>
                                <div class="title-line mt-2" style="width: 80px; height: 4px; background: var(--grn-grd); border-radius: 2px;"></div>
                            </div>

                            <p class="card-text mb-4 lead" style="color: var(--text); line-height: 1.7;">The Directorate of Youth Affairs, Khyber Pakhtunkhwa was
                                established as independent Directorate in the year 2017. Our vision is to foster a society where every young person
                                ...
                                <div class="row g-3">
                                    <div class="col-sm-6">
                                        <div class="value-item d-flex align-items-center p-2 rounded-3 hover-effect" 
                                            ...
                                            <div class="rounded-circle p-2 me-3" style="background-color: white; box-shadow: 0 3px 10px rgba(5, 150, 105, 0.1);">
                                                <i class="fas fa-check" style="color: var(--grn);"></i>
                                            </div>
                ...
                <div class="col-md-6">
                    <div class="card vision-policy-card h-100 border-0 shadow position-relative overflow-hidden" 
                         style="border-radius: 20px; transform: translateY(0); transition: all 0.3s ease;">
                        <!-- Card top gradient border -->
                        <div class="position-absolute top-0 start-0 w-100" style="height: 6px; background: var(--blue-grd); z-index: 1;"></div>
                        
                        <!-- Curved background shape -->
                        <div class="position-absolute start-0 bottom-0" style="width: 200px; height: 200px; background: var(--blue-grd); opacity: 0.05; border-radius: 0 100% 0 0; transform: translate(-30%, 30%);"></div>
                        ...
                        <div class="card-body p-4 p-lg-5">
                            <div class="vision-header mb-4 d-flex flex-column align-items-start">
                                <div class="icon-wrapper p-3 rounded-4 mb-3 position-relative" 
                                    ...
                                    <!-- Animated pulsing circle behind icon -->
                                    <div class="position-absolute top-50 start-50 translate-middle rounded-circle" 
                                         style="width: 40px; height: 40px; background: var(--blue); opacity: 0.2; animation: pulse-policy 2s infinite;"></div>
                                    <i class="fas fa-file-alt fs-2" style="color: var(--blue); position: relative; z-index: 2;"></i>
                                </div>
                                <h3 class="card-title fs-2 fw-bold mb-0 gradientHeading2" style="font-size: 2.25rem !important;">Youth Policy</h3>
                                <div class="title-line mt-2" style="width: 80px; height: 4px; background: var(--blue-grd); border-radius: 2px;"></div>
                            </div>

                            <p class="card-text mb-4 lead" style="color: var(--text); line-height: 1.7;">Khyber Pakhtunkhwa Youth Policy is the central tool to systemically
                                integrate, implement, and evaluate all youth development work in the province, providing a comprehensive framework for growth and progress.</p>
                            ...
                            <div class="policy-pillars">
                                ...
                                <div class="policy-pillar mb-4 p-0">
                                    <div class="policy-pillar-card rounded-4 p-3 position-relative"
                                        ...
                                        <div class="position-absolute top-0 end-0 m-2" style="width: 15px; height: 15px; border-radius: 50%; background: var(--light-grn); opacity: 0.5;"></div>
                                ...
                                <div class="policy-pillar mb-4 p-0">
                                    <div class="policy-pillar-card rounded-4 p-3 position-relative"
                                        ...
                                        <!-- Mini corner decorator -->
                                        <div class="position-absolute top-0 end-0 m-2" style="width: 15px; height: 15px; border-radius: 50%; background: var(--blue); opacity: 0.2;"></div>
                                ...
                                <div class="policy-pillar mb-4 p-0">
                                    <div class="policy-pillar-card rounded-4 p-3 position-relative"
                                        ...
                                        <!-- Mini corner decorator -->
                                        <div class="position-absolute top-0 end-0 m-2" style="width: 15px; height: 15px; border-radius: 50%; background: linear-gradient(135deg, var(--grn), var(--blue)); opacity: 0.3;"></div>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-lg-7 d-flex align-items-center">
                                    <div class="p-4 p-lg-5">
                                        ...
                                        <p class="mb-4" style="color: var(--text);">The KP Scholarship Program is dedicated to providing financial assistance to deserving students from Khyber Pakhtunkhwa. Join our program and be part of our mission to empower the next generation.</p>
