                            ...
                            <div class="col-md-12 mb-4">
                                <div class="input-group ">
                                    ...
                                    <input type="text" class="form-control"
                                        placeholder="Search by keyword, department, level..." aria-label="Username"
            ...
            <div class="row mt-5">
                <div class="col-xs-12 col-md-6 col-lg-4 col-xl-3 mb-3">
                    <div class="card feature-scholarship-card">
                        ...
                        <span class="lab-type green">Merit-based</span>
                ...
                <div class="col-xs-12 col-md-6 col-lg-4 col-xl-3 mb-3">
                    <div class="card feature-scholarship-card">
                        <img src="./assets/imgs/scholar/s-1.png" class="card-img-top" alt="...">
                        <span class="lab-type blue">Merit-based</span>
                        <span class="lab-open">Open</span>
                        <div class="card-body">
                            <h5 class="card-title">Technical Innovation Scholarship</h5>
                            <p class="card-text">Technical Education</p>
                            <div class="detail">
                                <h5>Rs. 75,000</h5>
                                <span>
                                    <i class="fa-regular fa-user"></i>
                ...
                <div class="col-xs-12 col-md-6 col-lg-4 col-xl-3 mb-3">
                    <div class="card feature-scholarship-card">
                        <img src="./assets/imgs/scholar/s-3.png" class="card-img-top" alt="...">
                        <span class="lab-type red">Merit-based</span>
                        <span class="lab-open">Open</span>
                        <div class="card-body">
                            <h5 class="card-title">Girls Education Empowerment</h5>
                            <p class="card-text">Elementary & Secondary Education</p>
                            <div class="detail">
                                <h5>Rs. 75,000</h5>
                                <span>
                                    <i class="fa-regular fa-user"></i>
                ...
                <div class="col-xs-12 col-md-6 col-lg-4 col-xl-3 mb-3">
                    <div class="card feature-scholarship-card">
                        <img src="./assets/imgs/scholar/s-4.png" class="card-img-top" alt="...">
                        <span class="lab-type purple">Merit-based</span>
                        <span class="lab-open">Open</span>
                        <div class="card-body">
                            <h5 class="card-title">Rural Development Scholarship</h5>
                            <p class="card-text">Rural Development</p>
                            <div class="detail">
                                <h5>Rs. 75,000</h5>
                                <span>
                                    <i class="fa-regular fa-user"></i>
                ...
                <div class="col-md-12 col-lg-9 col-xl-9 mx-auto">
                    <div class="help-slider">
                        <div class="help-slider-item">
                            ...
                            <p class="message"><i>"The KP Scholarships Portal completely transformed my educational
                                    journey. The
                                    transparent process and easy application system helped me focus on my studies
                                    rather
                                    than financial worries."</i></p>
        ...
        <div class="container">
            ...
            <div class="row d-flex justify-content-center align-items-center my-5">
                <div class="col-xs-12 col-md-5 col-lg-3 col-lg-3 mb-2">
                    <button class="btn btn-solid-white icon w-100"><i class="fas fa-search"> </i> Browse All
                        Scholarships</button>
                </div>
                <div class="col-xs-12 col-md-4 col-lg-2 col-lg-2">
                    <button class="btn btn-outline-white icon w-100"><i class="fas fa-rocket"> </i>Start Your
                        Journey</button>
                </div>
            </div>
            <div class="row">
