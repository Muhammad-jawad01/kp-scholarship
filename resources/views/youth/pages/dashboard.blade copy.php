...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-body">
            ...
            <div class="table table-responsive pt-0 mt-3">
                ...
                <table class="table">
                    ...
                    <tbody>
                        @forelse ($historyModels as $history)
                            <tr>
                                <td>{{ $history->id }}</td>
                                <td>{{ $history->student_name ?? 'N/A' }}</td>
                                <td>{{ $history->scholarship_name ?? 'N/A' }}</td>
                                <td>{{ $history->status ?? 'N/A' }}</td>
                                <td>
                                    <a
                                        href="{{ route('print.history', ['encryptedHistoryId' => encrypt($history->id)]) }}">
                                        <i data-feather="printer"></i> print
                                    </a>
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="5">No history applications found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
            ...
            <!-- End History Applications Table -->
