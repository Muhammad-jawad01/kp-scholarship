...
@section('title', 'Sign Up - Youth Registration')
    ...
    <div class="auth-wrapper auth-v1 ">
        <div class="auth-inner py-2">
            ...
            <p class="card-text mb-2">Please sign-in to your account and start the adventure</p> -->
                    ...
                    <form class="auth-login-form mt-2" method="POST" action="{{ route('youth-registration-register') }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nic') is-invalid @enderror" id="nic"
                                name="nic" placeholder="CNIC" aria-describedby="nic" tabindex="1" autofocus
                                value="{{ old('nic') }}" />
                            @error('nic')
                                <span>
                                    <p style="color: red;">{{ $message }}</p>
                        ...
                        <div class="form-group">
                            <label for="nic" class="form-label">Domicile District</label>
                            <select name="domicile_district_id" id="" class="form-control">
                                <option value="0"> -- Select Domicile District -- </option>
                                @foreach ($districts as $district)
                                    <option value="{{ $district->id }}">{{ $district->name }}</option>
                                @endforeach
                            </select>
                            @error('domicile_district_id')
                                <span>
                                    <p style="color: red;">{{ $message }}</p>
                                </span>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('email') is-invalid @enderror"
                                id="email" name="email" placeholder="Email" aria-describedby="email"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('mobile_no') is-invalid @enderror"
                                id="mobile_no" name="mobile_no" placeholder="Mobile Number" aria-describedby="mobile_no"
                                tabindex="1" autofocus value="{{ old('mobile_no') }}" />
                            @error('mobile_no')
                                <span>
                                    <p style="color: red;">{{ $message }}</p>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group input-group-merge form-password-toggle">
                                <input type="password" class="form-control form-control-merge" id=""
                ...
                <div class="custom-control custom-checkbox">
                  ...
                  <label class="custom-control-label" for="remember"> Remember Me </label>
                    ...
                    <p class="text-center mt-2">
                        <span>Already have an account? <a class="btn btn-success"
                                href="{{ route('youth-registration-login') }}">Login</a></span>
