                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="mobile_number"  value="{{$model->mobile_number ?? ""}}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="">Telephone Number</label>
                                <input type="number" class="form-control" name="telephone_number" value="{{$model->telephone_number ?? ""}}">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="income_from_other_sources" min="0" value="{{$model->income_from_other_sources ?? ""}}">
                            </div>
                        </div>
