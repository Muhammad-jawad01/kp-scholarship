                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="program_duration" id="program_duration" class="form-control">
                                    @for ($i = 1; $i <= 5; $i++)
                                        <option value="{{ $i }}"
                                            {{ $i == Auth::user()->program_duration ? 'selected' : '' }}>
                                            {{ $i }}{{ $i == 1 ? '' : ($i == 2 ? '' : ($i == 3 ? '' : '')) }}
                                            Year
                                        </option>
                                    @endfor
                                ...
                                {{-- <select name="program_duration" id="" class="form-control">
                                    <option value="1" {{ Auth::user()->program_duration == 1 ? 'selected' : '' }}>1st Semester
                                    </option>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="current_semester" id="current_semester" class="form-control">
                                    @for ($i = 1; $i <= 10; $i++)
                                        <option value="{{ $i }}"
                                            {{ $i == Auth::user()->current_semester ? 'selected' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <select name="marital_status" id="" class="form-control">
                                    ...
                                    <option value="Un married"
                                        {{ Auth::user()->marital_status == 'Un married' ? 'selected' : '' }}>Un-Married
                                    </option>
