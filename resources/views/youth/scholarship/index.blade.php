            ...
            <div class="row">
                <div class="col-md-11 mx-auto">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {{-- <input type="text" class="form-control" name="university_name"
                                    value="{{ auth('student')->user()->university_name }}"> --}}
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="campus"
                                    value="{{ auth('student')->user()->campus }}">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="discipline"
                                    value="{{ auth('student')->user()->discipline }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="sub_discipline"
                                    value="{{ auth('student')->user()->sub_discipline }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {{-- <input type="number" class="form-control" name="program_duration"
                                    value="{{ auth('student')->user()->program_duration }}"> --}}
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {{-- <input type="number" class="form-control" name="current_semester"
                                    value="{{ auth('student')->user()->current_semester }}"> --}}
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="father_name"
                                    value="{{ auth('student')->user()->father_name }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="marital_status" id="" class="form-control">
                                    ...
                                    <option value="Married"
                                        {{ auth('student')->user()->marital_status == 'Married' ? 'selected' : '' }}>
                                        Married
                                    </option>
                                    <option value="Un married"
                                        {{ auth('student')->user()->marital_status == 'Un married' ? 'selected' : '' }}>
                                        Un-Married
                                    </option>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="">CNIC <small>put Cnic without dash</small></label>
                                <input type="number" class="form-control" name="nic"
                                    value="{{ auth('student')->user()->cnic }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="mobile_no"
                                    value="{{ auth('student')->user()->mobile_no }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nationality"
                                    value="{{ auth('student')->user()->nationality }}">
                            </div>
                        </div>
