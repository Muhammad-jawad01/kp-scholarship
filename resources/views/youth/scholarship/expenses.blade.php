                                    ...
                                    @else
                                        ...
                                        @for ($i; $i <= 2; $i++)
                                            <tr>
                                                ...
                                                <td>
                                                    {{-- <input type="text" class="form-control" name="financially_supporting[]"> --}}
                                                    {!! Form::select('financially_supporting[]', \Helper::financially_supporting(), null, [
                                                        'class' => 'form-control',
                                                    ]) !!}
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::select('accommodation_type', \Helper::accommodation_type(), $model->accommodation_type ?? '', [
                                    'class' => 'form-control',
                                ]) !!}
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="address" id="" rows="5" class="form-control">{{ $model->address ?? '' }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="other_house_details" id="" rows="5" class="form-control"> {{ $model->other_house_details ?? '' }}</textarea>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control"
                                                name="average_telephone_bill_six_months"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control"
                                                name="average_family_misc_expenditure"
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="number" class="form-control" name="per_month_disposable_income"
                                                placeholder="25000"
                                                value="{{ $model->per_month_disposable_income ?? '' }}">
                                        </td>
                                    </tr>
                                </tbody>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::select('family_own_transport', \Helper::family_own_transport(), $model->family_own_transport ?? '', [
                                    'class' => 'form-control',
                                ]) !!}
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::select('family_own_cattle', \Helper::family_own_cattle(), $model->family_own_cattle ?? '', [
                                    'class' => 'form-control',
                                ]) !!}
                            </div>
                        </div>
                            ...
                            <table class="table table-bordered my-2">
                                ...
                                <tbody>
                                        ...
                                        @foreach ($scholarship_assets as $assets)
                                            <tr>
                                                ...
                                                <td><input type="number" class="form-control"
                                                        value="{{ $assets->quantity ?? '' }}" name="quantity[]"></td>
                                                <td><input type="number" class="form-control"
                                                        value="{{ $assets->current_market_value ?? '' }}"
                                                        name="market_value[]"></td>
                                            </tr>
                                        @endforeach
                                    @endif
                                    ...
                                    @if ($scholarship_assets->isEmpty())
                                        <tr>
                                            <td>Other House <input type="hidden" class="form-control"
                                                    value="Other House" name="type[]"></td>
                                            <td><input type="number" min="0" class="form-control" name="quantity[]" value="0"></td>
                                            <td><input type="number" min="0" class="form-control" name="market_value[]" value="0"></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td>Bank Balance <input type="hidden" class="form-control"
                                                    value="Bank Balance" name="type[]"></td>
                                            <td><input type="number" min="0" class="form-control" name="quantity[]" value="0"></td>
                                            <td><input type="number" min="0" class="form-control" name="market_value[]" value="0"></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <th>Total <input type="hidden" class="form-control" value="Total"
                                                    name="type[]"></th>
                                            <td><input type="number" min="0" class="form-control" name="quantity[]" value="0"></td>
                                            <td><input type="number" min="0" class="form-control" name="market_value[]" value="0"></td>
                                        </tr>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="statement_purpose" id="" rows="5" class="form-control">{{ $model->statement_purpose ?? '' }}</textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="">How did you know about KPEF merit and Needs- based Scholarships
                                    Program?</label>
                                <textarea name="KPEF_merit_Needsbased_scholarships_program" id="" rows="5" class="form-control">{{ $model->KPEF_merit_Needsbased_scholarships_program ?? '' }}</textarea>
                            </div>
                        </div>
                    </div>
