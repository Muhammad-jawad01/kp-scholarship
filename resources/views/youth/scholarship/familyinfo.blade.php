                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::select('father_status', \Helper::father_status(),$model->father_status ??"",
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="father_cnic"
                                    value="{{$model->father_cnic ?? ""}}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::select('father_earning', \Helper::father_earning(),$model->father_earning
                                ??"",
                                array('class' => 'form-control')) !!}
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="father_guardian"
                                    value="{{$model->father_guardian ?? ""}}">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="employer_address"
                                    value="{{$model->employer_address ?? ""}}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="">Address of Employer</label>
                                <input type="text" class="form-control" name="father_guardian_designation"
                                    value="{{$model->father_guardian_designation ?? ""}}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="financial_support"
                                    value="{{$model->financial_support ?? ""}}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="">Father/Guardian NTN Number and Tax paid</label>
                                <input type="text" class="form-control" name="father_ntn_number"
                                    value="{{$model->father_ntn_number ?? ""}}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::select('mother_status', \Helper::mother_status(),$model->mother_status ??"",
                                array('class' => 'form-control')) !!}
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::select('mother_profession',
                                \Helper::mother_profession(),$model->mother_profession
                                ??"", array('class' => 'form-control')) !!}
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="professional_status"
                                    value="{{$model->professional_status ?? ""}}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::select('parent_marriage_relationship',
                                \Helper::parent_marriage_relationship(),$model->parent_marriage_relationship ??"",
                                array('class' => 'form-control')) !!}
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="total_family_members"
                                    value="{{$model->total_family_members ?? ""}}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="">Dependent Family Members</label>
                                <input type="number" class="form-control" name="dependent_family_members"
                                    value="{{$model->dependent_family_members ?? ""}}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="">Total Earning Member(s)</label>
                                <input type="number" class="form-control" name="total_earning_members"
                                    value="{{$model->total_earning_members ?? ""}}">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="family_members_studying"
                                    value="{{$model->family_members_studying ?? ""}}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="">No. of Brother(s)</label>
                                <input type="number" class="form-control" name="num_of_brothers"
                                    value="{{$model->num_of_brothers ?? ""}}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="">No. of Sister(s)</label>
                                <input type="number" class="form-control" name="num_of_sisters"
                                    value="{{$model->num_of_sisters ?? ""}}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="family_income"
                                    value="{{$model->family_income ?? ""}}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="">Income From Other Sources</label>
                                <input type="number" class="form-control" name="income_from_other_sources" min="0"
                                    value="{{$model->income_from_other_sources ?? ""}}">
                            </div>
                        </div>
