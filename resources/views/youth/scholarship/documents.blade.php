                ...
                <div class="row mt-2">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            @php
                            $signature1 = optional(
                            \Carbon\Carbon::parse($model->father_guardian_signature ?? null),
                            )->format('Y-m-d');
                            $signature2 = optional(
                            \Carbon\Carbon::parse($model->applicant_signature ?? null),
                            )->format('Y-m-d');
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            @if ($model)
                            <input type="checkbox" class="" id="myCheckbox" name="terms_conditions" value="1"
                                {{ old('terms_conditions', $model->terms_conditions ?? false) ? 'checked' : '' }}>
