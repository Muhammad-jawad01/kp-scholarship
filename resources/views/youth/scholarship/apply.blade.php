            ...
            <div class="row">
                <div class="col-md-12 mx-auto">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-3 text-right">
                                    <input type="radio" name="scholarship_id" value="{{ $scholarship->id }}"
                                        id="scholarship_{{ $scholarship->id }}" class="form-check-input d-none"
                            ...
                            <div id="requirements_{{ $scholarship->id }}" class="scholarship-requirements">
                                @include(
                        ...
                        <input type="radio" name="scholaer" id="scholarId-{{$scholarship->id}}" class="d-none">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="applied_year"><i class="fas fa-calendar"></i> Applied for
                                        Academic Year *</label>
                                    <input type="number" class="form-control" value="{{ date('Y') }}" id="applied_year"
                                        name="applied_year" min="{{ date('Y') }}" max="{{ date('Y') + 5 }}" required
                                        {{ !$isProfileComplete ? 'disabled' : '' }}>
                                </div>
                            </div>
                            <div class="col-md-4">
